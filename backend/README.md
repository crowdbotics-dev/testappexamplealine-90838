...
## Project Structure
    ...
    ├── testappexamplealine_90838  # Django project configurations
...
1. Clone this repo and `cd testappexamplealine_90838`
...
2. Clone this repo and `cd testappexamplealine_90838`
